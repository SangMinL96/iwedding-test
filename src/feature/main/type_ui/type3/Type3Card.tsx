...
const Type3Card = ({ item, imgBelowExpose, thumbnailRatio, orderBadgeFlag, indexNum, isLike = false }: PropsType) => {
    ...
    >
      ...
      {imgBelowExpose ? null : (
        <>
          ...
          {!orderBadgeFlag && item.floating_icon && item.floating_icon > 0 && (
