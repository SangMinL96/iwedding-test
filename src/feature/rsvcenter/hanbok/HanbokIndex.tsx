  ...
  const onSubmit = async data => {
    ...
    if (!from) {
      ...
      const result = await mutate(
        rsvCenterKeys.procResult,
        easyBookProcAPI({
          easy_book: { ...data.easy_book, type3: '1', type, category: '한복' },
...
export default React.memo(HanbokIndex);
...
const Container = styled.form<StyledProps>`
  ...
  height: 750px;
  overflow: hidden;
  background-color: ${props => props.isDeskTop && '#ff8b74'};
