...
const RobesModal = ({ visible, onClose, isFullSize, onConfirm, data }: AvailableProps) => {
        ...
        {data?.type === '1' && (
          <>
            ...
            <ContentBox>
              ...
              {data?.fitting !== '0' && (
                <QcontentBox>
                  <h5>Q. 대여 예복 상담 시, 직접 피팅을 원하시나요?</h5>
                  <p> - {onSection4('3', data?.fitting)}</p>
                </QcontentBox>
              )}
              <QcontentBox>
                <h5>Q. 어떤 예복샵을 방문하고 싶으신가요?</h5>
