...
function Content6({ setIsValidate }) {
  ...
  return (
    <ContentBox>
      <h3>희망 식사 메뉴와 식대가 어떻게 되나요?</h3>
      <p style={{ color: 'blue' }}>최대 2개까지 선택할 수 있어요.</p>
      <InputBox>
        <SelectButton style={{ width: '49%' }}>뷔페</SelectButton>
        <SelectButton style={{ width: '49%' }}>한식</SelectButton>
        <SelectButton style={{ width: '49%' }}>양식</SelectButton>
        <SelectButton style={{ width: '49%' }}>무관</SelectButton>
      </InputBox>
    </ContentBox>
  );
}
